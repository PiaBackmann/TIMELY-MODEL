...
to setup
  ...
  set simulation-length 420;; in ticks (6 ticks pro tag)
 ...
 ; set overall-mean-damage-plants 0     ;; prozentualer anteil schaden von gesamtbiomasse die insgesamt produziert wurde
  ...
  ;   print (word "frequency " frequency " tau1-zahl: " tau1-pflanzen " tau2-zahl " tau2-pflanzen)
     let filestring (word "/home/pixi/Desktop/Projekte/Time_delay/Modell/einfache_tests/data/larval_masses.txt")
   ; let filestring (word "/home/pixi/Desktop/Projekte/Time_delay/Modell/einfache_tests/wachstum/Wachstum.txt")
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
to go
;  if(mean [biomass-larva] of larvae > 400)
 ; [
  ; stop 
  ;]
    tick   
...
<experiments>
  ...
  <experiment name="Delay_time" repetitions="1" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="randomseed" first="1" step="1" last="30"/>
    <enumeratedValueSet variable="switch?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="level-GA">
    ...
    <steppedValueSet variable="tau1" first="48" step="6" last="60"/>
    <enumeratedValueSet variable="resource-limitation-above">
      <value value="0.15"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="intrinsic-growth-rate">
  ...
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="false">
    ...
    <metric>PRODUCTIVITY</metric>
    <metric>count plants</metric>
    <metric>defense-switch-count</metric>
    <metric>sum-visited</metric>
    <metric>pupation-counter</metric>
    <metric>switch-counter</metric>
    <enumeratedValueSet variable="larva-waves">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="wave-larvae">
  ...
  <experiment name="switch_and_death_behaviour" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>PRODUCTIVITY</metric>
    <metric>count plants</metric>
    <metric>sum-unique-visited-pupation</metric>
    <metric>sum-visited-pupation</metric>
    <metric>pupation-counter</metric>
    <enumeratedValueSet variable="larva-waves">
      <value value="1"/>
    </enumeratedValueSet>
